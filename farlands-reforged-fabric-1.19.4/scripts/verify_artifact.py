...
# 1.20.x reads the plural folder; Minecraft 1.21 renamed it to advancement/.
ADVANCEMENT = 'data/farlandsreforged/advancements/farlands/where_am_i.json'
required_entries = {
    'fabric.mod.json',
...
with zipfile.ZipFile(jar) as zf:
    ...
    advancement = zf.read(ADVANCEMENT).decode('utf-8')

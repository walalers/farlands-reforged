...
Forge build of Farlands Reforged. Same terrain code as the Fabric and NeoForge projects (the six worldgen mixins
...
./gradlew build -Pminecraft_version=26.1.2 -Pforge_version=64.0.10 -Pforge_loader_major=64 \
  "-Pminecraft_version_range=[26.1.2,26.2)" -Pmod_version=0.3.0+mc26.1.2-forge
```

...
public final class FarlandsEvents {
    private static final ResourceLocation WHERE_AM_I_ADVANCEMENT = new ResourceLocation("farlandsreforged", "farlands/where_am_i");
    ...
    public static void awardIfInFarlands(ServerPlayer player) {
        ...
        // Before 1.20 there is no Entity.level() accessor; ServerPlayer's own server field is the stable way in.

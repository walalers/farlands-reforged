...
public final class FarlandsCommands {
    ...
    private static int showInfo(CommandSourceStack source) {
        ...
        tell(source, Component.literal("The Far Lands start at ±" + startX + " on X and ±" + startZ + " on Z (classic: ±" + FarlandsConfig.CLASSIC_FARLANDS_START + ")."));
        tell(source, Component.literal("Distance to the Far Lands: " + distance + " blocks."));
    ...
    private static int showFarMan(CommandSourceStack source) {
        tell(source, Component.literal("FarMan is " + (FarlandsConfig.farManEnabled() ? "on" : "off") + ". He only walks the Far Lands (past ±" + FarlandsRegion.startX() + " on X or ±" + FarlandsRegion.startZ() + " on Z, in the Overworld)."));
        return 1;
    }

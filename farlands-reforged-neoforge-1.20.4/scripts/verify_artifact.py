...
with zipfile.ZipFile(jar) as zf:
    ...
    # NeoForge 20.2 and 20.3 only turn a mod's resources into a pack when pack.mcmeta is present; without
    # it they log "Missing metadata in pack" and the advancement never registers.
    if 'pack.mcmeta' not in names:
        raise SystemExit('pack.mcmeta is missing; NeoForge 20.2/20.3 would silently drop the data pack.')

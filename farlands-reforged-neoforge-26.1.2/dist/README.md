...
A tiny NeoForge `26.1.2` mod that restores classic Far Lands-style terrain generation by preserving full coordinate precision in Minecraft's Perlin noise wrapping method.
